...
namespace IPCU.Controllers
{
    ...
    public class UTIFormController : Controller
    {
        ...
        public UTIFormController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration, PatientDbContext patientContext)
        {
            _context = context;
        ...
        {
            // Ensure the concatenated checkbox values are stored
            model.TypeClass = TypeClass != null ? string.Join(", ", TypeClass) : "";
            model.DateCreated = DateTime.Now;

            // Sanitize nullable culture result fields
            var nullableFields = new List<string>
    {
        ...
        "ABUTI_CultureResults"
            ...
            if (ModelState.IsValid)
            {
                ...
                // Get latest IdNum using AdmDate from tbpatient
                string idNum = null;
