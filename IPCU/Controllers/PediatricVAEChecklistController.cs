...
namespace IPCU.Controllers
{
    public class PediatricVAEChecklistController : Controller
    {
        ...
        public PediatricVAEChecklistController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration, PatientDbContext patientContext)
        {
            _context = context;
